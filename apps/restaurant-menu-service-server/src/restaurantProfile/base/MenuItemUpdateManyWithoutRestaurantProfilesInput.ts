...
@InputType()
class MenuItemUpdateManyWithoutRestaurantProfilesInput {
...
export { MenuItemUpdateManyWithoutRestaurantProfilesInput as MenuItemUpdateManyWithoutRestaurantProfilesInput };
